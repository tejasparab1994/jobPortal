  ...
  render() {
    return(
      <Router>
            ...
            <Route path="/githubToken" exact={false} render={() => <div><Search channel={this.props.channel}/><div className="container"><Results jobs={this.props.state.jobs} channel={this.props.channel}/></div></div>} />
