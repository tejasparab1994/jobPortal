defmodule JobPortalWeb.PageController do
  ...
  def githubLogin(conn, params) do
    ...
    resp =
      HTTPoison.post!(
        "https://github.com/login/oauth/access_token?client_id=41f8f887360cc3177894&client_secret=c0748c6d0b8a6dffb27bb1769392b76a23a54ec9&code=#{
          code
        }&accept=json",
        "{\"body\": \"test\"}",
    ...
    gituser = %{
      id: authenticdata["id"],
      name: authenticdata["login"],
      email: authenticdata["email"]
    }
